$(document).ready(function () {
  $("#register-form").on("submit", function (event) {
    ...
    if (!validPassword.test(password)) {
      alert(
        "Contraseña inválida. Debe tener al menos 8 caracteres, una letra mayúscula, una letra minúscula, un dígito y un carácter especial."
      );
      return;
    }
    ...
    if (!validNombre.test(nombre)) {
      alert(
        "Nombre de usuario inválido. Debe tener entre 3 y 15 caracteres y puede contener letras, números, guiones bajos y puntos."
      );
      return;
    }
    ...
    if (!validApellido.test(apellido)) {
      alert(
        "Apellido de usuario inválido. Debe tener entre 3 y 15 caracteres y puede contener letras, números, guiones bajos y puntos."
      );
      return;
    }
